CXXFLAGS=-Wall -O3 -g
OBJECTS=matrix_clock.cpp matrix_clock.h matrix_color.cpp matrix_font.cpp text_line.cpp time_period.cpp variable_utility.cpp telegram_handler.cpp matrix_data.cpp matrix_telegram.h
